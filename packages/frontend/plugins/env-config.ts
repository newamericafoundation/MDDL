 ...
 * object vi an inline <script> tag. As our CSP policy doesn't allow inline scripts,
 * and as Nuxt currently doesn't support appending nonce/hash appending to inline scripts
